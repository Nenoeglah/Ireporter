...
def seed_data():
    ...
    record_image1 = RecordImage(record=record1, image_url="https://example.com/image1.jpg")
    record_video1 = RecordVideo(record=record1, video_url="https://example.com/video1.mp4")

    record_image2 = RecordImage(record=record2, image_url="https://example.com/image2.jpg")
    record_video2 = RecordVideo(record=record2, video_url="https://example.com/video2.mp4")
